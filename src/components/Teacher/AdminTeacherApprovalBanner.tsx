    ...
    >
      ...
      <div className="mt-3.5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {pendingTeachers.map((teacher) => (
          <div
            key={teacher.id}
            className="bg-slate-900/90 border border-amber-500/30 hover:border-amber-400/60 rounded-xl p-3 shadow-sm flex flex-col justify-between transition-all group"
          >
            <div>
              <div className="flex items-center space-x-3">
                <img
                  ...
                  alt={teacher.name}
                  className="w-10 h-10 rounded-full border border-amber-400/50 bg-slate-800 object-cover shrink-0"
                  onError={(e) => {
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center space-x-1 text-[11px] text-amber-300/90 font-medium truncate mt-0.5">
            ...
            <div className="mt-3 pt-2.5 border-t border-slate-800 flex items-center justify-end space-x-2">
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 text-rose-300 border border-rose-500/30 text-[11px] font-bold transition-colors cursor-pointer flex items-center space-x-1"
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-[11px] font-bold transition-all shadow-sm shadow-emerald-950 flex items-center space-x-1 cursor-pointer"
